...
namespace Olive.CodeBuilder
{
    ...
    internal sealed class RightCmd
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("a9f42fb0-958d-4a18-b010-ea9987930a3d");
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            DTE dte =  (DTE)package.GetServiceAsync(typeof(DTE)).GetAwaiter().GetResult();
